...
export default defineConfig({
  ...
  projects: [
    {
      ...
      use: {
        ...
        permissions: [
          /* Allow copy paste from browser context */
          'clipboard-read',
          'clipboard-write',
        ],
      },
  ...
  webServer: {
    ...
    command: `concurrently --kill-others-on-fail "pnpm mockserver" "pnpm build:test && PORT=${process.env.VITE_PORT} node .output/server/index.mjs"`,
